...
public class Reader {
    ...
    /**
     * This method deals the case that we encounter a start of block line
     * @param file the s-java file
     * @param mainBlock the block we are in
     * @param scan the scanner we use
     * @param line the line we are in the file
     * @throws FileNotFoundException
     * @throws VariableException
     * @throws MethodException
     * @throws MainScopeException
